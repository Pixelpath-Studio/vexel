 ...
 * VexelFile and on each frame updates the renderer's per-element
...
internal class Animator(
    ...
    file: VexelFile,
    private val session: VexelSession?,
        ...
        session?.let { s ->
            if (s.version != lastSnapshotVersion) {
                ...
                try {
                    ...
                    android.util.Log.w("Vexel", "session refresh failed", e)
                }
            }
        }
