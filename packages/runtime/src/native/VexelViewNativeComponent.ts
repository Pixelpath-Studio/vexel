...
// native view manager; this spec declares the JS↔native bridge that VexelView.tsx
// drives.
...
export interface NativeProps extends ViewProps {
  /** Base64-encoded .vex bytes (Fabric strings ferry binary data). */
...
export default codegenNativeComponent<NativeProps>('VexelView') as HostComponent<NativeProps>;
